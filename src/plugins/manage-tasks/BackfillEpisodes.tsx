...
const BackfillEpisodes: FC = () => {
  ...
  const initialValues: FormValues = {
    ...
    rssBackfillUrl: taskId ? extractRssUrl(taskConfig) : '',
    sourceBackfillUrl: taskId ? extractRssUrl(taskConfig) : '',
    taskConfig: taskId ? taskConfig : 'No task selected',
    selectedSeries: '',
    backfillTaskConfig: '',
    extras: '',
    sourceTaskName: taskId ? extractTaskName(taskConfig) : '',
  };
...
export default BackfillEpisodes;
