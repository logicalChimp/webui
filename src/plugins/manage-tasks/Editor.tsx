...
import { YamlLanguage, Schema } from './editorTypes';
...
const Editor: FC<Props> = ({ name, schemas, height = 500 }) => {
  ...
  return (
    <div style={{ padding: '1em 0', backgroundColor: themes[theme.palette.type].background.default }}>
      <MonacoEditor
        height={height}
        language="yaml"
